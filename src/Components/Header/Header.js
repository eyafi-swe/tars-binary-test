...
const Header = () => {
    ...
    return (
        ...
        <div className='navbarContainer h-16'>
            ...
            <nav className='lg:w-11/12   mx-auto flex justify-between items-center'>

                <div className='w-11/12 lg:w-max lg:mx-0  mx-auto flex justify-between items-center'>

                    <div className="h-6 w-6 text-white lg:hidden mr-2" onClick={() => setOpen(!open)}>
                        {
                ...
                <div className={`navItems  text-white text-sm   lg:flex lg:w-max lg:py-0 w-screen py-4   absolute lg:static duration-700 ease-in ${open ? 'top-16' : 'top-[-1200px]'}`}>

                    <div className='lg:hidden flex justify-center w-full border-b border-gray-500 py-2 px-2'>
                ...
                <div className='lg:flex  hidden'>
                    <div className=''>
                        <img src={search} alt="Search Icon" className='h-7 text-gray-300' />
                    </div>
